...
//        when(...).thenReturn(...): This is a Mockito syntax used to define the behavior of a mock object.
//        You specify that when the findAllRestaurants() method is called on the restaurantService mock,
//        it should return a predefined result.

//        mockRestaurants: This is the predefined result you want to return when findAllRestaurants() is called.
//        It is typically a mock or a dummy list of restaurants that you have created for the purpose of your test.
